 ...
 *
 * A registered sitemap is re-fetched by Google on its own schedule, so new
 * pages get discovered without anyone pressing anything. Submitting is a
 * nudge that shortens the wait after a batch of pages ships.
 *
